...
<header>
	<H1>Lists of courses available in Spring semester</H1>
</header>
<body>
	...
	<sql:query var="listCourses" dataSource="${myDatabase}">
        SELECT * FROM Course WHERE semesterType = 'Spring';
    </sql:query>
    
<form method="post" action="/task/springCourses.jsp">
			...
			<tr>
				...
				<td>
					<section title=".squaredThree">
						...
						<input type="checkbox" value="${itemCatalog.courseName} ${itemCatalog.numofECTS}" id="mycheck"
								name="mycheck"/>
						</div>
						<!-- end .squaredThree -->
					</section>
